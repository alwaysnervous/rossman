...
\begin{itemize}
    ...
    \item сформировать базовый набор признаков и дополнительные группы признаков, включающие исторические, календарно-праздничные и внешние признаки;
...
Рассматриваемые дополнительные признаки можно разделить на три типа: исторические признаки продаж, календарно-праздничные признаки и внешние признаки. К внешним признакам в данной работе относятся погодные данные, Google Trends и уровень безработицы; лаги и праздничные признаки рассматриваются отдельно, поскольку они имеют другую природу.
